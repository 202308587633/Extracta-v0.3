...
class SettingsTab(ctk.CTkFrame):
    ...
    def _setup_ui(self):
        ...
        # 2. Criação do Frame de Formulário
        ...
        self.maint_frame = ctk.CTkFrame(self, fg_color="#4a1818") 
        self.maint_frame.pack(fill="x", padx=20, pady=10)

        # Botão Resetar Fontes (NOVO)
        self.btn_reset_sources = ctk.CTkButton(
            self.maint_frame, text="🔓 Desbloquear Fontes (Reset Status)", 
            command=self.viewmodel.reset_blocked_sources,
            fg_color="#d35400", hover_color="#e67e22"
        )
        self.btn_reset_sources.pack(pady=10)
